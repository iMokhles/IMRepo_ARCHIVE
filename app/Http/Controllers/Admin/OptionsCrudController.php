...
use App\Http\Requests\OptionsRequest as StoreRequest;
use App\Http\Requests\OptionsRequest as UpdateRequest;
use Illuminate\Http\Response;

class OptionsCrudController extends CrudController
{
    public function setup()
    {
        ...
        |--------------------------------------------------------------------------
        */
        $this->crud->setModel('App\Models\Options');
