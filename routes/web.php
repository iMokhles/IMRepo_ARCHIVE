...
Route::get('/repo/icon/{section_name}', 'Repo\HomeController@icon')->name('show_icon');
...
Route::get('/CydiaIcon', 'Repo\RepoController@getCydiaIcon');

Route::get('/CydiaIcon.png', 'Repo\RepoController@getCydiaIconPng');
