(function(i, g, c, j, e, k, f) { /*! Jssor */
    ...
    var b = i.$Jssor$ = new function() {
        ...
        function Gb() {
            if (!M) {
                M = {
                    ig: "ontouchstart" in i || "createTouch" in g
                };
                var a;
                if (E.pointerEnabled || (a = E.msPointerEnabled)) M.qe = a ? "msTouchAction" : "touchAction"
            }
            return M
        }
        ...
        h.$GetElement = function(a) {
            if (h.Rf(a)) a = g.getElementById(a);
            return a
        };
        ...
        h.ad = m("transformOrigin", 4);
        h.hg = m("backfaceVisibility", 4);
        h.Nf = m("transformStyle", 4);
        h.Mf = m("perspective", 6);
        h.Yf = m("perspectiveOrigin", 4);
        h.bg = function(a, b) {
        ...
        h.ng = function(d, a) {
            if (a) d.style.clip = "rect(" + c.round(a.$Top || a.C || 0) + "px " + c.round(a.$Right) + "px " + c.round(a.$Bottom) + "px " + c.round(a.$Left || a.D || 0) + "px)";
            else if (a !== f) {
        ...
        h.ve = function(a, b) {
            var c = h.tc(a);
            b & 1 && h.E(a, (h.$CssWidth(c) - h.$CssWidth(a)) / 2);
            b & 2 && h.z(a, (h.$CssHeight(c) - h.$CssHeight(a)) / 2)
        };
        h.ac = function(b, a) {
        ...
        h.Dd = function(n, i, s, t, B, C, o) {
            ...
            if (n) {
                ...
                if (w) {
                    ...
                    if (r() && l >= 11 && (i.D || i.C) && s != 0 && s != 1) a.$Rotate = a.$Rotate || 1e-8;
                    a.He = e
                }
            }
            if (i.$Clip && o.$Move) {
            ...
            if (a.$Clip && b.Zf() && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.C && !a.$Clip.D && a.$Clip.$Right == o.$OriginalWidth && a.$Clip.$Bottom == o.$OriginalHeight) a.$Clip = j;
            return a
        }
    };
    ...
    i.$JssorSlideshowRunner$ = function(n, s, q, u, z, A) {
        ...
        function i(g, f) {
            ...
            t(a);
            a.lc = a.$Cols * a.$Rows;
            a.$Easing = b.Ec(a.$Easing, d.$Swing);
        ...
        function p(z, i, a, v, n, l) {
            ...
            b.$Each(o, function(i, m) {
                b.$Each(i, function(G) {
                    ...
                    if (K) {
                        ...
                        if (a.$Clip) {
                            ...
                            if (C && z) {
                                i.$Top = g.Q / 2 * w;
                                i.$Bottom = -i.$Top
                            } else if (C) i.$Bottom = -g.Q * w;
                            else if (z) i.$Top = g.Q * w;
                            if (B && A) {
                                i.$Left = g.R / 2 * w;
                                i.$Right = -i.$Left
                            } else if (B) i.$Right = -g.R * w;
                            else if (A) i.$Left = g.R * w
                        }
                        r.$Clip = t;
                        f.$Clip = g[v]
                    }
                    ...
                    h[v].Ge = y + D - 1;
                    for (var F = 0; F <= D; F++) {
                        var E = b.Dd(f, r, F / D, a.$Easing, a.$During, a.$Round, {
                            $Move: a.$Move,
                            $OriginalWidth: n,
                            $OriginalHeight: l
                        });
        ...
        f.Bc = function(E) {
            if (!u) {
                ...
                for (var f = 0; f < s; f++) {
                    var C = b.dg();
                    b.$InnerText(C, f + 1);
                    var k = b.dd(g, "numbertemplate", C, e);
                    b.F(k, "absolute");
                    var v = f % (m + 1);
                    b.E(k, !h ? n * v : f % i * n);
                    b.z(k, h ? r * v : c.floor(f / (m + 1)) * r);
                    b.$AppendChild(d, k);
                    B[f] = k;
                    a.$ActionMode & 1 && b.$AddEvent(k, "click", b.$CreateCallback(j, t, f));
                    a.$ActionMode & 2 && b.$AddEvent(k, "mouseover", b.Pb(b.$CreateCallback(j, t, f), k));
                    y[f] = b.Qb(k)
                }
                u = e
            }
    ...
    i.$JssorThumbnailNavigator$ = function(g, B) {
        ...
        function A(q, f) {
            ...
            g.hb = f;
            g.rd = r;
            m = q.Lf || q.kc || b.$CreateDiv();
            g.Sb = c = b.dd(l, "thumbnailtemplate", m, e);
            o = b.Qb(c);
            a.$ActionMode & 1 && b.$AddEvent(c, "click", b.$CreateCallback(j, h, 0));
            a.$ActionMode & 2 && b.$AddEvent(c, "mouseover", b.Pb(b.$CreateCallback(j, h, 1), c))
        }
        i.Ic = function(b, e, f) {
            var a = p;
            p = b;
    ...
    var h = i.$JssorSlider$ = function() {
        ...
        var ub = "data-jssor-slider",
            Tb = "data-jssor-thumb",
            q, o, cb, bb, S, ib, R, Z, P, y, z, ab, sb, Mb, Jb, hb, Vb, Ub, Y, s = -1,
            M, yb, r, I, H, Gb, pb, qb, Kb, t, mb, w, O, Ib, U = [],
            cc, dc, Zb, ic, Bc, v, db, E, bc, ob, vb, zb, lb, Ab, J, fb, K, F = 1,
            Q, D, T, Bb = 0,
            Cb = 0,
            L, jb, kb, Nb, x, W, A, Db, gb, Wb = [],
            V = [],
            Ob = b.$Device(),
            Fb = Ob.ig,
            B = [],
        ...
        function qc(n, m) {
            ...
            b.Md = function() {
                Q = e;
                T = j;
                a.l(h.$EVT_SWIPE_START, u(x.X()), x.X())
            };
            b.Pd = function() {
                Q = k;
                i = k;
                var b = x.lf();
                a.l(h.$EVT_SWIPE_END, u(x.X()), x.X());
                !b.wb && Cc(b.jf, s)
            };
            b.cc = function(h, e) {
                var a;
        ...
        function xc(i, f) {
            ...
            function F(a) {
                ...
                R(i, a, 0);
                D = e;
                q = new S.$Class(i, S, b.Ue(b.$AttributeEx(i, "idle")) || bc, !v);
                q.L(0)
            }
                ...
                if (r == 1) {
                    ...
                    if (a) {
                        var g = T = b.T(),
                            c = f + db,
                            e = B[u(c)];
                        return e.zb(b.$CreateCallback(j, V, c, e, a, g), y)
                    }
                } else Hb(db)
            };
            d.Mc = function() {
            ...
            function R(a, f, c, h) {
                ...
                b.$Each(i, function(a) {
                    ...
                    if (g == "caption") {
                        if (f) {
                            b.ad(a, b.$AttributeEx(a, "to"));
                            b.hg(a, b.$AttributeEx(a, "bf"));
                            L && b.$AttributeEx(a, "3d") && b.Nf(a, "preserve-3d")
                        }
                    } else if (!D && !c && !n) {
                        if (d == "A") {
                            if (b.$AttributeEx(a, "u") == "image") n = b.gg(a, "IMG");
        ...
        function wc(z, g, p, q) {
            ...
            function w() {
                b.Ac(N);
                ic && m && o.Zd && b.$AppendChild(N, o.Zd);
                b.B(N, !m && o.kc)
            }
        ...
        function jc(f) {
            if (!D && (F || !(E & 12)) && !A.$IsPlaying()) {
                var b = x.X(),
                    a = c.ceil(G);
                if (f && c.abs(L) >= o.$MinDragOffsetToSlide) {
                    a = c.ceil(b);
                    a += kb
                }
                if (!(J & 1)) a = c.min(r - t, c.max(a, 0));
                var e = c.abs(a - b);
        ...
        function gc(c, d) {
            ...
            Ib = k;
            var f = b.Ib(m, "1", Tb);
            if ((!f || f === q) && !O && (!d || c.touches.length == 1) && !b.Ib(m, "nodrag") && vc()) {
                if (d) {
                    var l = c.touches[0];
                    Bb = l.clientX;
                    Cb = l.clientY
                ...
                D = e;
                T = j;
                b.$AddEvent(g, d ? "touchmove" : "mousemove", Lb);
                b.T();
                K = 0;
                kc();
                if (!tb) w = 0;
        ...
        function Lb(d) {
            if (D) {
                ...
                if (f) {
                    var g = f.x - Bb,
                        h = f.y - Cb;
                    if (w || c.abs(g) > 1.5 || c.abs(h) > 1.5) {
                        if (c.floor(G) != G) w = w || cb & O;
                        if ((g || h) && !w)
                            if (O == 3)
                                if (c.abs(h) > c.abs(g)) w = 2;
                                else w = 1;
                            else {
                                w = O;
                                var m = [0, c.abs(g), c.abs(h)],
                                    o = m[w],
                                    n = m[~w & 3];
                                if (n > o) Ib = e
                            }
        ...
        function X() {
            ...
            if (D) {
                ...
                A.lb();
                var c = x.X();
                a.l(h.$EVT_DRAG_END, u(c), c, u(G), G);
                E & 12 && ac();
                jc(e)
            }
        }
        ...
        function Pb(h, g, l, m) {
            if (Ab && (!D && (F || !(E & 12)) || o.$NaviQuitDrag)) {
                ...
                if (!(J & 1))
                    if (m) a = u(a);
                    else if (J & 2 && (a < 0 && !M || a > r - t && M >= r - t)) a = a < 0 ? r - t : 0;
        ...
        function Qb(c, d) {
            ...
            gb = c / (d ? b.$CssHeight : b.$CssWidth)(y);
            b.bg(y, gb);
            var h = d ? gb * eb() : c,
                e = d ? c : gb * nb();
            b.$CssWidth(q, h);
        ...
        a.Ob = function(x, l) {
            ...
            cb = o.$PlayOrientation & 3;
            bb = o.$SlideshowOptions;
            S = b.q({
                $Class: p
            }, o.$CaptionSliderOptions);
            ib = o.$BulletNavigatorOptions;
            R = o.$ArrowNavigatorOptions;
            Z = o.$ThumbnailNavigatorOptions;
            P = !o.$UISearchMode;
            z = b.$FindChild(q, "slides", P);
            ab = b.$FindChild(q, "loading", P) || b.$CreateDiv(g);
            sb = b.$FindChild(q, "navigator", P);
            Mb = b.$FindChild(q, "arrowleft", P);
            Jb = b.$FindChild(q, "arrowright", P);
            hb = b.$FindChild(q, "thumbnavigator", P);
            Vb = b.$CssWidth(z);
            Ub = b.$CssHeight(z);
            I = o.$SlideWidth || Vb;
            H = o.$SlideHeight || Ub;
            ...
            if (r) {
                ...
                if (bb) {
                    ic = bb.$ShowLink;
                    vb = bb.$Class;
                    zb = t == 1 && r > 1 && vb && (!b.$IsBrowserIE() || b.$BrowserVersion() >= 9)
                }
                lb = zb || t >= r || !(J & 1) ? 0 : o.$Align;
                if (r > t) fb = (t > 1 || lb ? cb : -1) & o.$DragOrientation;
                Ob.qe && b.$Css(z, Ob.qe, ([j, "pan-y", "pan-x", "none"])[fb] || "");
                if (zb) C = new vb(Db, I, H, bb, Fb, wb);
                ...
                b.$AddEvent(q, "mouseout", b.Pb(nc, q));
                b.$AddEvent(q, "mouseover", b.Pb(mc, q));
                if (fb) {
                    b.$AddEvent(q, "mousedown", gc);
                    b.$AddEvent(q, "touchstart", uc);
                    b.$AddEvent(q, "dragstart", Rb);
                    b.$AddEvent(q, "selectstart", Rb);
                    b.$AddEvent(i, "mouseup", X);
                    b.$AddEvent(g, "mouseup", X);
                    b.$AddEvent(g, "touchend", X);
                    b.$AddEvent(g, "touchcancel", X);
                    b.$AddEvent(i, "blur", X)
                }
                if (sb && ib) {
                    cc = new ib.$Class(sb, ib, eb(), nb());
                    U.push(cc)
                }
                if (R && Mb && Jb) {
                    R.$Loop = J;
                    R.$Cols = t;
                    dc = new R.$Class(Mb, Jb, R, eb(), nb());
                    U.push(dc)
                }
                if (hb && Z) {
                    Z.$StartIndex = o.$StartIndex;
                    Zb = new Z.$Class(hb, Z);
                    b.$Attribute(hb, Tb, "1");
                    U.push(Zb)
                }
                ...
                o.$ArrowKeyNavigation && b.$AddEvent(g, "keydown", function(a) {
                    if (a.keyCode == 37) rb(-o.$ArrowKeyNavigation, e);
                    else a.keyCode == 39 && rb(o.$ArrowKeyNavigation, e)
                });
                var h = o.$StartIndex;
                h = u(h);
                A.Hb(h, h, 0)
